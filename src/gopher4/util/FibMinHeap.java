...
public class FibMinHeap {
    ...
    public static FibMinHeap create_heap() {
        return new FibMinHeap();
    }
    ...
    public static void merge_heap(FibMinHeap H1, FibMinHeap H2, FibMinHeap H3) {
        H3.min = H1.min;
