...
public class Comms {
    ...
    private final int INDEX_OF_WELL_LOCATIONS_STACK_START = 0;
    private final int MEMORY_ALLOCATED_TO_WELL_LOCATIONS_STACK = 30;

    private final int INDEX_OF_ENEMY_LOCATIONS_QUEUE_START = 30;
