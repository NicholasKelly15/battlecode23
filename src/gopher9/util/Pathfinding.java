...
//        }
        ...
        if (pathingMode == 0) {
            ...
            moveTowards(rc.getLocation().add(direction).add(direction).add(direction).add(direction));
        }


    }

    public void moveTowards(MapLocation target) throws GameActionException {
